        ...
        do {
            ...
            try {
                (switch (userInput) {
                    ...
                    case "upload" -> new FileUploadCommand(transport, io, tokenHolder);
                    case "download" -> new FileDownloadCommand(transport, io, tokenHolder);
                    case "delete" -> new FileDeleteCommand(transport, io, tokenHolder);
                    case "dir create" -> new DirectoryCreateCommand(transport, io, tokenHolder);
                    case "move" -> new FileMoveCommand(transport, io, tokenHolder);
